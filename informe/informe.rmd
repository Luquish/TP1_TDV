...
El grafo resultante $G$ tiene la siguiente estructura $G = (V, E)$
...
![Tiempo de Ejecución - Greedy vs Batching](../src/output/figures/greedy_vs_batching_time.png)
...
![Priority vs Batching vs Greedy - Instancias Originales](../src/output/figures/results_combined_original.png)

Como la función de costo unitario del modelo de `Batching` es directamente proporcional con la función de costo unitario de `TaxiPriority` ya que ambas dependen directamente de la distancia entre el Taxi y el Pasajero de la siguiente forma:
...
![Valor Objetivo - Priority vs Batching vs Greedy - Instancias Aleatorias](../src/output/figures/solutions_random.png)
![Costo de Taxistas - Priority vs Batching vs Greedy  - Instancias Aleatorias](../src/output/figures/taxi_priorities_random_grouped.png)
...
![Mejora Relativa - Priority vs Batching - Instancias Aleatorias](../src/output/figures/relative_improvement_priority_vs_min_cost_flow.png)
...
![Mejora Relativa - Priority vs Batching std - Instancias Aleatorias](../src/output/figures/relative_improvement_priority_vs_min_cost_flow_boxplot.png)
...
![Tiempo de Ejecución - Batching vs Priority](../src/output/figures/time_comparison_priority_vs_min_cost_flow.png)
